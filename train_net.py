...
from mask2former import (
    ...
    MaskFormerSemanticADEMixDatasetMapper,
    MaskFormerSemanticStreetHazardsMapper,
    SemanticSegmentorWithTTA,
    COCOPanopticOpenEvaluator,
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        # COCO Open Panoptic
        if "open_panoptic" in cfg.INPUT.DATASET_MAPPER_NAME:
            evaluator_list.append(COCOPanopticOpenEvaluator(dataset_name, output_folder, cfg))
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic":
        ...
        elif cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic_void":
            mapper = MaskFormerSemanticVoidDatasetMapper(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
            ...
            return build_detection_train_loader(cfg, mapper=mapper)
        elif cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic_street_hazards_coco_mix":
            mapper = MaskFormerSemanticStreetHazardsCOCOMixMapper(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
        elif cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic_ade_mix":
            mapper = MaskFormerSemanticADEMixDatasetMapper(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
        ...
        # coco panoptic segmentation lsj new baseline
            ...
            return build_detection_train_loader(cfg, mapper=mapper)
        elif cfg.INPUT.DATASET_MAPPER_NAME == "open_panoptic_coco_mapper":
            mapper = OpenPanopticCOCODatasetMapper(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
        else:
            mapper = None
            return build_detection_train_loader(cfg, mapper=mapper)
...
def main(args):
    ...
    trainer = Trainer(cfg)
    trainer.resume_or_load(resume=True)#args.resume)
