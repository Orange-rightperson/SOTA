...
__all__ = ["MaskFormerSemanticCocoMixDatasetMapper"]
...
def random_resize(image: np.ndarray, mask: np.ndarray, scale_range=(0.2, 1.0)):
    """
    对图像和对应掩码进行随机尺度缩小。
...
class MaskFormerSemanticCocoMixDatasetMapper:
    """
