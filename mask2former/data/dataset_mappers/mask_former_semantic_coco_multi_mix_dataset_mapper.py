...
__all__ = ["MaskFormerSemanticCocoMultiMixDatasetMapper"]
...
class MaskFormerSemanticCocoMultiMixDatasetMapper:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        if sem_seg_gt is not None:
            ...
            for i in range(ood_num):
                ...
                oulier_masks.append(outlier_mask)
            outlier_masks = torch.Tensor(outlier_masks)
