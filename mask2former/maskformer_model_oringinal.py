...
class MaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.test_proposal_sampler_1=NLSSampler(thresh=0, ignore_mask=None, method="fps", num_points=10)
    ...
    def forward(self, batched_inputs, include_void=False, return_separately=False, 
        ...
        features = self.backbone(images.tensor)#reshape_images)#images.tensor)
    ...
    def set_requires_grad(self, nets, requires_grad=False):
        ...
        for param in nets.mask_decoder.parameters():#.output_hypernetworks_mlps.parameters():
        ...
        for i in range(x.shape[0]):
           ...
           # dense_embeddings = nn.functional.gelu(dense_embeddings)
            ...
            (
                ...
                dense_prompt_embeddings=dense_embeddings,#dense_embeddings,#dense_embeddings,
            ...
            mask = mask > 0#0.5#self.predictor.model.mask_threshold
            #mask = (road.bool())*mask
            ...
            for i in range(mask.shape[0]):
                nls_mean = (1-road)*nls
                nls_score = nls_mean[mask.squeeze(1)[i]].mean()
                if nls_score.isnan():
    ...
    def fine_with_sam(self, x, uncert, inlier_output, o_feature):
        ...
        uncertainty =nls_uncert+uncertainty#uncertainty+nls_uncert#+
